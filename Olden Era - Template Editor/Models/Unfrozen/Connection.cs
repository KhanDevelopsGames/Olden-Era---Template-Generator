...
namespace OldenEraTemplateEditor.Models
{
    public class Connection
    {
        ...
        /// <summary>
        /// Runtime-only flag set to <see langword="true"/> when this connection was added manually
        /// inside the Zone Connection Editor (i.e. it was not generated by <see cref="Services.TemplateGenerator"/>).
        /// Never written to the .rmg.json output.
        /// </summary>
        [JsonIgnore]
