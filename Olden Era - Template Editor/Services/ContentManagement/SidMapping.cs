...
namespace OldenEraTemplateEditor.Services.ContentManagement
{
    ...
    public static class ContentIds
    {
        ...
        public static readonly SidMapping AlchemyLab = new() { Sid = "alchemy_lab", Name = "Alchemical Lab" };
        public static readonly SidMapping Arena = new() { Sid = "arena", Name = "Pit of Glory" };
        ...
        public static readonly SidMapping CelestialSphere = new() { Sid = "celestial_sphere", Name = "Celestial Spire" };
        ...
        public static readonly SidMapping Circus = new() { Sid = "circus", Name = "Travelling Circus" };
        public static readonly SidMapping CollegeOfWonder = new() { Sid = "college_of_wonder", Name = "Mountain Monastery" };
        public static readonly SidMapping CrystalTrail = new() { Sid = "crystal_trail", Name = "Dragon Step" };
        ...
        public static readonly SidMapping FickleShrine = new() { Sid = "fickle_shrine", Name = "Four Scholars Shrine" };
        public static readonly SidMapping FlatteringMirror = new() { Sid = "flattering_mirror", Name = "World Mirror" };
        ...
        public static readonly SidMapping JoustingRange = new() { Sid = "jousting_range", Name = "Colosseum" };
        public static readonly SidMapping ManaWell = new() { Sid = "mana_well", Name = "Well" };
        public static readonly SidMapping Market = new() { Sid = "market", Name = "Marketplace" };
        ...
        public static readonly SidMapping MysteriousStone = new() { Sid = "mysterious_stone", Name = "Whispering Stones" };
        public static readonly SidMapping MysticalTower = new() { Sid = "mystical_tower", Name = "Altar of Insight" };
        public static readonly SidMapping ScrollBox = new() { Sid = "scroll_box", Name = "Magic Scroll" };
        public static readonly SidMapping EnchantedScrollBox = new() { Sid = "enchanted_scroll_box", Name = "Enchanted Magic Scroll" };
        public static readonly SidMapping MythicScrollBox = new() { Sid = "mythic_scroll_box", Name = "Mythic Magic Scroll" };
        public static readonly SidMapping OrbObservatory = new() { Sid = "orb_observatory", Name = "Four Scholars Observatory" };
        public static readonly SidMapping PandoraBox = new() { Sid = "pandora_box", Name = "Pandora's Box" };
        ...
        public static readonly SidMapping Prison = new() { Sid = "prison", Name = "Hero Cage" };
        public static readonly SidMapping QuixsPath = new() { Sid = "quixs_path", Name = "Quix's Altar" };
        ...
        public static readonly SidMapping ShadyDen = new() { Sid = "shady_den", Name = "Trophy Hunter's Den" };
        ...
        public static readonly SidMapping TheGorge = new() { Sid = "the_gorge", Name = "Carrion Pile" };
        public static readonly SidMapping TownGate = new() { Sid = "town_gate", Name = "Town Gate" };
        public static readonly SidMapping TreeOfAbundance = new() { Sid = "tree_of_abundance", Name = "Arborcopia" };
        ...
        public static readonly SidMapping UnforgottenGrave = new() { Sid = "unforgotten_grave", Name = "Tomb of Vigilance" };
        public static readonly SidMapping University = new() { Sid = "university", Name = "University" };
        public static readonly SidMapping UnstableRuins = new() { Sid = "unstable_ruins", Name = "Overgrown Vori Ruins" };
        public static readonly SidMapping Watchtower = new() { Sid = "watchtower", Name = "Redwood Observatory" };
        ...
        public static readonly SidMapping StorageCrystals = new() { Sid = "storage_crystals", Name = "Crystal Storage" };
        public static readonly SidMapping StorageGemstones = new() { Sid = "storage_gemstones", Name = "Gem Storage" };
        public static readonly SidMapping StorageDust = new() { Sid = "storage_dust", Name = "Alchemical Dust Storage" };
        public static readonly SidMapping Gardener = new() { Sid = "gardener", Name = "Magic Garden" };
        ...
        public static readonly SidMapping PeasantCart = new() { Sid = "peasant_cart", Name = "Abandoned Cart" };
        public static readonly SidMapping AbandonedCorpse = new() { Sid = "abandoned_corpse", Name = "Forgotten Remains" };
        ...
        public static readonly SidMapping AlvarsEye = new() { Sid = "alvars_eye", Name = "Alvar Outpost" };
        ...
        public static readonly SidMapping LegionsMemorial = new() { Sid = "legions_memorial", Name = "Legion's Memorial" };
        public static readonly SidMapping MereasShrine = new() { Sid = "mereas_shrine", Name = "Mearea's Altar" };
        public static readonly SidMapping MontyHall = new() { Sid = "monty_hall", Name = "The Monty Hall" };
        public static readonly SidMapping OvergrownGrave = new() { Sid = "overgrown_grave", Name = "Ancient Crypt" };
        public static readonly SidMapping PrismaticLair = new() { Sid = "prismatic_lair", Name = "Prismatic Nest" };
        public static readonly SidMapping RaidersCamp = new() { Sid = "raiders_camp", Name = "Raiders' Camp" };
        public static readonly SidMapping HerosCrypt = new() { Sid = "heros_crypt", Name = "Tomb of a Nameless Hero" };
        ...
        public static readonly SidMapping ArmoryAutomaton = new() { Sid = "armory_automaton", Name = "Summit Automaton" };
        ...
        public static readonly SidMapping Maze = new() { Sid = "maze", Name = "Living Maze" };
        public static readonly SidMapping TrialScales = new() { Sid = "trial_scales", Name = "Scales of Worth" };
